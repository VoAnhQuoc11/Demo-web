...
public class EchoServer {
    public static void main(String[] args) {
        ...
        try (ServerSocket serverSocket = new ServerSocket(port)) {
            ...
            // Xử lý lỗi port đã bị dùng
            System.out.println("LOI: Cong (Port) " + port + " dang bi chiem dung boi ung dung khac!");
            System.out.println("Vui long tat Server cu hoac doi Port khac.");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
